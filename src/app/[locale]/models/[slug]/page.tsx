...
function t(key: string, locale: string): string {
  const dict: Record<string, Record<string, string>> = {
    modelNotFound: { ja: "モデルが見つかりません", en: "Model not found", ko: "모델을 찾을 수 없습니다" },
    backToModels: { ja: "モデル一覧に戻る", en: "Back to Models", ko: "모델 목록으로" },
    home: { ja: "ホーム", en: "Home", ko: "홈" },
    modelList: { ja: "モデル一覧", en: "Models", ko: "모델" },
    openSource: { ja: "オープンソース", en: "Open Source", ko: "오픈소스" },
    conditional: { ja: "条件付オープン", en: "Conditional Open", ko: "조건부 오픈" },
    proprietary: { ja: "プロプライエタリ", en: "Proprietary", ko: "독점" },
    params: { ja: "パラメータ", en: "Parameters", ko: "파라미터" },
    contextWindow: { ja: "コンテキスト長", en: "Context Window", ko: "컨텍스트" },
    license: { ja: "ライセンス", en: "License", ko: "라이선스" },
    releaseDate: { ja: "リリース日", en: "Release Date", ko: "출시일" },
    apiPricing: { ja: "API料金", en: "API Pricing", ko: "API 가격" },
    inputPrice: { ja: "入力料金（1Mトークンあたり）", en: "Input Price (per 1M tokens)", ko: "입력 가격 (1M 토큰당)" },
    outputPrice: { ja: "出力料金（1Mトークンあたり）", en: "Output Price (per 1M tokens)", ko: "출력 가격 (1M 토큰당)" },
    billingMode: { ja: "課金モード", en: "Billing Mode", ko: "과금 모드" },
    pricingUnavailable: { ja: "このモデルのAPI料金情報は現在未公開です", en: "API pricing for this model is not yet available", ko: "이 모델의 API 가격 정보는 현재 공개되지 않았습니다" },
    strengths: { ja: "強み", en: "Strengths", ko: "강점" },
    weaknesses: { ja: "弱み", en: "Weaknesses", ko: "약점" },
    useCases: { ja: "活用例", en: "Use Cases", ko: "활용 사례" },
    type_reasoning: { ja: "推論", en: "reasoning", ko: "추론" },
    type_coder: { ja: "コーディング", en: "coding", ko: "코딩" },
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        ko: `https://aimodelsnavi.com/ko/models/${model.slug}`,
