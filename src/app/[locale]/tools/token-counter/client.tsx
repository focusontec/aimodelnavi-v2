...
const T = {
  ...
  ko: {
    title: "토큰 카운터 & 프롬프트 비용 계산기",
    subtitle: "프롬프트를 붙여넣기만 하면 토큰 수, API 비용, 모델 비교를 즉시 확인. 100% 브라우저 내에서 처리되어 프롬프트가 외부로 전송되지 않습니다.",
    placeholder: "프롬프트 텍스트를 여기에 붙여넣으세요...",
    selectModel: "모델 선택",
    outputRatio: "출력 배율",
    requestsDay: "일일 요청 수",
    inputTokens: "입력 토큰",
    ...
    dailyCost: "일일 비용",
    monthlyCost: "월간(30일)",
    contextUsage: "컨텍스트 사용률",
    noPricing: "가격 데이터 없음",
    compareTitle: "모델 비교",
    compareSub: "같은 프롬프트로 모든 모델의 비용 비교",
    model: "모델",
    provider: "프로바이더",
    inputPrice: "입력 가격",
    outputPrice: "출력 가격",
    ...
    bestContext: "최대 컨텍스트",
    bestPremium: "프리미엄",
    privacy: "프라이버시: 프롬프트는 브라우저 내에서 처리되며 서버로 전송되지 않습니다.",
    builderTitle: "프롬프트 빌더",
    builderSub: "항목을 입력하면 구조화된 프롬프트를 자동 생성",
    role: "역할",
    task: "태스크",
    context: "컨텍스트",
    requirements: "요구사항",
    ...
    howTokensWork: "AI 토큰의 원리",
    howCostCalc: "프롬프트 비용 계산 방법",
    whyDiffer: "모델마다 토큰 수가 다른 이유",
    howToReduce: "프롬프트 비용 절감 방법",
    howToChoose: "최적 모델 선택 방법",
    faq: "자주 묻는 질문",
