...
tag: オープンソース
excerpt: >-
  Alibabaが発表したQwen3.7シリーズのMaxとPlusモデルを詳細比較。テキスト推論・コーディングに特化したMaxと、マルチモーダル対応のPlusの性能、価格、ユースケースの違いを解説し、最適な選択基準を提示する。
---
...
- [Qwen3.7-Plusが登場：画像理解能力を備えたマルチモーダルAIの最前線](/blog/qwen37-plus-ai)
