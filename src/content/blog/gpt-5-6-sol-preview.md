...
date: "2026-06-27"
tag: "OpenAI"
excerpt: "OpenAIが次世代モデルGPT-5.6の限定プレビューを開始。フラッグシップのSolは「ultraモード」によりサブエージェントを活用した並列処理を実現し、Terminal-Bench 2.1やサイバーセキュリティ分野で新SOTAを達成した。コスト最適化されたTerraとLunaも含め、エージェント協調という新たなパラダイムを提示する。"
---
