...
tag: オープンソース
excerpt: >-
  階躍星辰がリリースしたStep 3.7 Flashは、Claude Opus
  4.6の約1/9のコストで同等のコーディング能力を実現し、プロダクションレベルのエージェント向けに設計された高効率モデルだ。スパースMoEアーキテクチャでアクティベーションパラメータ11B、400
  Tokens/sの高速生成を特徴に、マルチモーダル理解、ツール呼び出し安定性、ワークフロー適応性を強化し、エージェントのスケーラブルな商用化を推進する。
---
