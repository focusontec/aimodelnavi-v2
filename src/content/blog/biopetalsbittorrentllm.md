...
tag: オープンソース
excerpt: >-
  生物学特化モデル「OpenBioLLM」を分散環境で動作させるBioPetalsが登場。BitTorrentのようなネットワーク構成により、低コストでの推論とファインチューニングを実現する仕組みを解説します。
...
- [華為の『τ定律』：7nm工場で1.4nm級の密度を実現する『論理折りたたみ』技術とは](/blog/article-2026-05-25-fk3o3v)
