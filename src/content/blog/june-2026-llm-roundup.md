...
date: "2026-06-24"
tag: "解説"
excerpt: "2026年6月は、LLM史上最多の主要モデルが集中リリースされた月となった。AnthropicのClaude Fable 5がコーディングベンチマークで新記録を樹立し、中国主要企業による「四馬レース」が激化する中、OpenAIとGoogleの次期フラッグシップモデルは延期が発表された。本記事では、この激動の1ヶ月を網羅的に解説する。"
---
...
| Llama 4.5 | Meta | オープン | 6月上旬 | エージェント安定性改善 |
| DeepSeek V4.1 | DeepSeek | オープン+クローズド | 6月上旬 | V4 Flash比15%トークン削減 |
| Mistral Medium 3 | Mistral AI | クローズド+セルフホスト | 6月上旬 | EU多言語ミッドティア |
| Hunyuan Large 3 | Tencent | クローズド+部分公開 | 6月上旬 | WeChat統合深化 |
| ERNIE 5.1 | Baidu | クローズド | 6月上旬 | Baidu検索統合 |
| Doubao Pro | ByteDance | クローズド | 6月上旬 | Douyinクリエイターエコノミー |
| GLM-6 | Zhipu AI | オープン | 6月上旬 | 中国オープンレース四馬レース参加 |
...
MetaのLlama 4.5はエージェントの安定性改善に焦点を当て、マルチステップ作業での信頼性を向上させた。
...
2026年6月の最も注目すべき動向の一つは、中国フロンティアモデル間の急速な競争激化だ。DeepSeek V4が4月に確立した価格パフォーマンス基準に対し、Alibaba、Tencent、Baidu、ByteDance、Zhipu AIが2週間以内に次々と対抗モデルを発表した。

### DeepSeek V4.1

DeepSeek V4.1はV4 Flash比で15%のトークン削減を実現。コスト効率の面で引き続きリーダーシップを維持している。

### Tencent Hunyuan Large 3

WeChatとの統合を深化させたモデル。中国最大のメッセージングプラットフォームでのネイティブAI体験を提供する。
...
Douyin（TikTok）のクリエイターエコノミーに特化したモデル。コンテンツ作成ワークフローの自動化を支援する。

### Zhipu AI GLM-6

中国オープンソースモデルレースの主要参加者。OSSコミュニティ向けの高品質モデルを提供する。
...
Qwen、DeepSeek、Hunyuan、GLMの4社が2週間以内に相次ぎリリースしたのは偶然ではない。DeepSeek V4が確立した価格パフォーマンス基準への競争的応答だ。中国の消費者・企業市場において、ブランドの可視性を高める動きが急速に広がっている。
...
- **コスト効率**: DeepSeek V4.1
- **消費者統合**: Hunyuan Large 3（WeChat）/ Doubao Pro（Douyin）

## まとめ

Claude Fable 5がコーディング能力の新基準を確立し、中国フロンティア四馬レースが競争の激化を象徴し、GPT-5.6とGemini 3.5 Proの延期は開発の複雑さを浮き彫りにした。
