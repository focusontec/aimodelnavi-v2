...
tag: DeepSeek
excerpt: >-
  AlibabaのQwen3.7-Maxが、未知のハードウェア上でのカーネル最適化において35時間の自律実行と10倍の性能向上を達成。タスク・ハーネス・検証器を分離した訓練手法により、高い汎化性能とエージェント能力を実現している。
---
...
- [Qwen3.7-PlusとQwen3.7-Maxの違いとは？画像理解が必要な場合の選択指針](/blog/qwen37-plus-qwen37-max)
