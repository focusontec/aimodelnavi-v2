---
title: "華為（ファーウェイ）の「τ定律」：7nmファブで1.4nm相当の密度を実現する「論理折りたたみ」とは"
date: "2026-05-25"
tag: "DeepSeek"
excerpt: "華為がISCAS 2026で発表した「τ定律」と「論理折りたたみ」技術。7nm級の工場で1.4nm級のトランジスタ密度を実現し、NVIDIA依存からの脱却を加速する。DeepSeek V4が華為昇騰チップを選んだ背景にある、半導体導体戦略の転換点を解説する。"
---

![華為チップ](/images/blog/article-2026-05-25-fk3o3v/img-1.png)

一ヶ月の間に、華為（ファーウェイ）のチップが二度もヘッドラインを飾った。

まずDeepSeekがV4シリーズを発表し、1.6兆パラメータのモデルをオープンソース化した。しかし業界が最も注目したのは別の事実だった——**DeepSeekが最初に最適化したハードウェアがNVIDIAではなく、華為の昇騰（Ascend）チップだった**ことだ。
